...
def perform_clustering(df, col1, col2):
    ...
    def plot_elbow_method():
        plt.figure(figsize=(12,7))
        plt.plot(K,inertias,marker='o',linestyle='-',color='royalblue', 
    ...
    def one_silhouette_inertia():
        ...
        _inertia = inertias[optimal_k - 2]  # Adjusting index since K starts at 2
...
def plot_clustered_data(labels, data, xkmeans, ykmeans, centre_labels):
    ...
    plt.scatter(xkmeans, ykmeans, marker='X', s=350, c='red', edgecolor='black', 
                linewidth=2.5, label='Centroids')
    for i, label in enumerate(centre_labels):
        plt.text(xkmeans[i], ykmeans[i], str(label), ha='center', va='bottom', 
